...
public class SparkTest {
	...
	public SparkTest(Class<? extends SparkTest> cl) {
	...
	public SparkTest useManualClock(){
		useManualClock=true;
		return this;
	}
	
	public SparkTest withBatchDurationMillis(long millis){
		batchDurationMillis=millis;
		return this;
	}
	
	public SparkTest withAppName(String name){
		appName=name;
		return this;
	}
	
	public SparkTest withMaster(String master){
		this.master=master;
		return this;
	}
